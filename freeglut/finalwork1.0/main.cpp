...
///finish
        ...
        drawbody();///身體
        glPushMatrix();
            ///glTranslatef(teapotX,teapotY, 0);///身體不動
            ///glRotatef(angle[3],1, 0, 0);
            glTranslatef(teapotX,teapotY, 0);
            drawrshoulder();///右肩膀
            glPushMatrix();
                glTranslatef(-0.013,-0.013, 0);///glTranslatef(teapotX,teapotY, 0);
                glRotatef(angle[3],1, 0, 0);
                glRotatef(angle[4],0, 1, 0);
                glTranslatef(-0.127,0.060, 0);///glTranslatef(teapotX,teapotY, 0);
                drawrarm();
                glPushMatrix();
                    glTranslatef(-0.113,-0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                    glRotatef(angle[1],1, 0, 0);
                    glTranslatef(-0.120,-0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                    drawrelbow();
                    glPushMatrix();
                        glTranslatef(0.673,0.107, 0);///glTranslatef(teapotX,teapotY, 0);
                        ///glRotatef(angle[0],1, 0, 0);
                        glTranslatef(-0.747,-0.107, 0);///glTranslatef(teapotX,teapotY, 0);
                        drawrpalm();
                    glPopMatrix();
                glPopMatrix();
            glPopMatrix();
            ...
            drawlshoulder();///肩膀
            glPushMatrix();
                glTranslatef(-0.000,-0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                ///glRotatef(angle[3],1, 0, 0);
                glTranslatef(0.133,0.060, 0);///glTranslatef(teapotX,teapotY, 0);
                drawlarm();
                glPushMatrix();
                    glTranslatef(-0.093,0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                    ///glRotatef(angle[1],1, 0, 0);
                    glTranslatef(0.213,0.000, 0);///glTranslatef(teapotX,teapotY, 0);
                    drawlelbow();
                    glPushMatrix();
                        glTranslatef(0.073,-0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                        ///glRotatef(angle[0],1, 0, 0);
                        glTranslatef(0.073,-0.007, 0);///glTranslatef(teapotX,teapotY, 0);
                        drawlpalm();
                    glPopMatrix();
